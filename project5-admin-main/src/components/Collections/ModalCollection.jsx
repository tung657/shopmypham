...
import { modalCollectionValidator } from '../../utils/validation';
...
export default function Modal({
  ...
  const handleSubmit = async (e) => {
    ...
    const validator = modalCollectionValidator(dataPost);
                ...
                <div className='flex flex-wrap p-4 h-[500px] overflow-y-auto'>
                  ...
                  <div className='w-full px-4 mt-2'>
                    <div className='relative w-full mb-3'>
                      ...
                      <div className='flex items-center'>
                        <div className='py-3 w-[50px] text-center rounded bg-slate-200 font-medium'>
                          #
                        </div>
                        <input
                          ref={hashtagRef}
                      ...
                      <small className='text-red-500 font-medium'>
                        {messages.map((message) =>
                          message.key === 'hashtag' ? message.message : null
                        )}
                      </small>
                    </div>
                  </div>
                    ...
                    <div className='w-full flex'>
                      <div className='relative'>
                        <img
                          ...
                          className='shadow-xl rounded h-[80px] align-middle w-[150px] border-2 border-red-500 object-cover'
                        />
                      </div>
                    </div>
                  </div>

                  <div className='w-full lg:w-1/2 px-4 mt-2'>
                    <div className='relative w-full mb-3'>
                      <label
                        className='block uppercase text-slate-500 text-xs font-bold mb-2'
                        htmlFor='grid-password'
                  ...
                  <div className='w-full lg:w-1/2 px-4 mt-2'>
                    <div className='relative w-full mb-3'>
                      ...
                      <small className='text-red-500 font-medium'>
                        {messages.map((message) =>
                          message.key === 'status' ? message.message : null
                        )}
                      </small>
                    </div>
                  </div>
