...
export default function CardTable({
  ...
  const handleSearch = (event) => {
    searchData({
      ...optionSearch,
      product_name: nameProductRef?.current?.value,
        ...
        <div className='rounded-t mb-0 px-4 py-3 border-0'>
          <div className='flex flex-wrap items-center'>
            ...
            <button
              ...
              type='button'
              onClick={() => {
                setTitleModal('Tạo mẫu sản phẩm');
                setItemSelected();
                setShowModal(true);
              }}
            >
              <i className='fas fa-plus'></i> Tạo mẫu
            </button>
          </div>
        </div>
              ...
              {currentItems &&
                currentItems.map((item, index) => (
                  <tr key={item._id}>
                    ...
                    <td className='border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap p-4'>
                      <div className='flex'>
                        <img
                          ...
                          alt='...'
                          className='w-[50px] object-cover rounded border-2 border-slate-50 shadow'
                        ></img>
                      </div>
                    </td>
                    <td className='border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap p-4'>
                    ...
                    <td className='border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap p-4'>
                      {item.category_sub?.sub_category_name}
                    </td>
                    <td className='border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap p-4'>
                      {item.brand?.brand_name}
                    </td>
                    <td className='border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap p-4'>
                      {item.collect?.collect_name}
                    </td>
                    <td className='border-t-0 px-6 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap p-4'>
                    ...
                    <td className='border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-right'>
                      <div className='flex items-center justify-center gap-1'>
                        <button
                          ...
                          type='button'
                          onClick={() => {
                            setTitleModal('Sửa mẫu sản phẩm');
                            setItemSelected(item);
                            setShowModal(true);
                          }}
                        >
