...
import Modal from './ModalDiscount';
import CardTable from './DiscountCardTable';
...
export default function MainDiscount({ data, setData, optionSearch, searchData, handlePost }) {
