...
import OrderAccount from '../../components/account/order/OrderAccount';
...
export default function AccountOrderPage({ setTitle }) {
  ...
  useEffect(() => {
    setTitle('Thông Tin Đơn Hàng | Artemis')
  }, [setTitle]);
      ...
      <div className='mx-auto max-w-[1920px] px-4 md:px-8 2xl:px-16'>
        <div className='py-16 lg:py-20 px-0 xl:max-w-screen-xl mx-auto flex md:flex-row w-full'>
          <div className='flex flex-col md:flex-row w-full'>
            ...
            <OrderAccount user={user} setUser={setUser} />
          </div>
        </div>
